...
class CoursesRepositoryImpl extends CoursesRepository {
  final _userCourseDataSource = UserCourseRemoteDataSource();
  ...
  @override
  Future<CoursesResponse> getFavoriteCourses() async => _favouriteDataSource.getFavoriteCourses();

  @override
  Future addFavoriteCourse(int courseId) async => _favouriteDataSource.addFavoriteCourse(courseId);

  @override
  Future deleteFavoriteCourse(int courseId) async => _favouriteDataSource.deleteFavoriteCourse(courseId);
