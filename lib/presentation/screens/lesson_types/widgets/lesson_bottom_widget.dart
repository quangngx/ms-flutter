              ...
              children: <Widget>[
                ...
                BlocBuilder<CompleteLessonBloc, CompleteLessonState>(
                  builder: (context, state) {
                    ...
                    for (var element in preferences.getStringList(PreferencesName.lessonComplete) ?? []) {
                      if (jsonDecode(element)['lesson_id'] == widget.lessonId) {
                        isCompleted = true;
                      }
                    }
                      ...
                      child: Padding(
                        ...
                        child: MaterialButton(
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              Icon(
                                widget.lessonResponse.completed || isCompletedCheck || isCompleted
                                    ? Icons.check_circle
