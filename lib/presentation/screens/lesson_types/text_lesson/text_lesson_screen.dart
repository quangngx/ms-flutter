...
class TextLessonWidgetState extends State<TextLessonWidget> {
  ...
  @override
  void initState() {
    BlocProvider.of<TextLessonBloc>(context).add(LoadTextLessonEvent(widget.courseId, widget.lessonId));
    super.initState();
  }
              ...
              builder: (context) {
                ...
                if (state is ErrorTextLessonState) {
                  return ErrorCustomWidget(
                    ...
                    onTap: () => BlocProvider.of<TextLessonBloc>(context)
                        .add(LoadTextLessonEvent(widget.courseId, widget.lessonId)),
                  );
                }
