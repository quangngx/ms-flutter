                    ...
                    children: <Widget>[
                      ...
                      ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          ...
                          var categoryObject = item!.categoriesObject.isNotEmpty ? item.categoriesObject.first : null;
    ...
    if (state is LoadedDetailProfileState) {
      if (state.isTeacher) {
        tabs.addAll(
          [
            Tab(
              text: 'profile_bio_tab'.tr(),
            ),
            Tab(text: 'profile_courses_tab'.tr()),
          ],
        );
      }
    }
