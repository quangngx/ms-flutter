          ...
          if (!state.courseDetailResponse.price!.free!) {
            list.add(
              _DefaultItem(
                ...
                title: 'one_time_payment'.tr(),
                subtitle: "${"course_regular_price".tr()} ${state.courseDetailResponse.price!.price}",
              ...
              state.userPlans!.subscriptions.forEach((value) {
                list.add(
                  _PriceItem(
                    ...
                    title: 'enroll_with_membership'.tr(),
                    subtitle: value.name,
              ...
              BlocProvider.of<CourseBloc>(context).availablePlans.forEach((value) {
                list.add(
                  _PriceItem(
                    ...
                    title: '${"available_in_plan".tr()} "${value.name}"',
                    subtitle: value.name,
                    value: value.quotasLeft.toString(),
                    onTap: () {
                      setState(() {
    ...
    return showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          content: Text('new_plan_over_the_old'.tr()),
          actions: <Widget>[
            ElevatedButton(
